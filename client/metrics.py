...
class MetricsCollector:
    ...
    def record_request_start(self, request_id: str, provider: str, model: str, 
                           prompt_tokens: int) -> RequestMetrics:
    ...
    def record_request_end(self, request_id: str, completion_tokens: int,
                          request_latency_ms: float, ttft_ms: Optional[float] = None,
    ...
    def _recalculate_provider_stats(self, provider_id: str):
        ...
        provider_requests = [r for r in self.request_metrics 
        ...
        ttfts = sorted([r.time_to_first_token_ms for r in provider_requests 
