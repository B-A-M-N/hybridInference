...
def run_workload(
    ...
    *,
    ...
    Simulates prefill pressure: after routing a request to endpoint X,
    we acquire a lease on X so subsequent requests see its pressure.
    Periodically releases leases to simulate completion.
    ...
    for i, req in enumerate(requests):
        # Periodically release leases to simulate completion
        ...
        # Simulate this request adding pressure to the endpoint
