...
from analyzer import analyze_latencies
from plotter import *
...
def main():
    ...
    for num_gpus in [1, 2]:
        ...
        for threshold in [100]:
            ...
            print(f"Token num stats for {label} (s):", hourly_total_requests, "\n", hourly_api_requests)
            ...
            plot_hourly_request_counts(hourly_total_requests, hourly_api_requests, model_name=model, local_hw=local_hw, cloud_provider=cloud_provider, label=label)
