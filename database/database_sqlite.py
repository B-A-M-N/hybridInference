...
class SQLiteDatabaseLogger:
    ...
    async def get_detailed_log(self, request_id: str) -> dict[str, Any] | None:
        """Get detailed log entry including prompt and response."""
        return await asyncio.get_event_loop().run_in_executor(
            None, self._get_detailed_log_sync, request_id
        )

    def _get_detailed_log_sync(self, request_id: str) -> dict[str, Any] | None:
