...
\textbf{Finding:} The gap between Greedy and Optimal is consistent across models (18--19\%), but the absolute savings are larger for expensive models. GPT-4 requests save \$0.85 $\times$ 89\% = \$0.76 per request under optimal routing, compared to \$0.08 $\times$ 61\% = \$0.05 for Mistral-7B.
