...
Usage:
    ...
    python ops/cloudflare/d1_migrate.py --dry-run

    # Full migration
    python ops/cloudflare/d1_migrate.py

    # Resume from checkpoint
    python ops/cloudflare/d1_migrate.py --resume

    # Custom batch size
    python ops/cloudflare/d1_migrate.py --batch-size 50

    # Validate only (compare row counts + spot-check)
    python ops/cloudflare/d1_migrate.py --validate-only
