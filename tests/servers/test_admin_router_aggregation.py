...
def test_admin_router_has_expected_route_count() -> None:
    ...
    """
    expected = 80  # includes role-quota, provider-key (incl. disable/enable/
    # enable-env), visibility, concurrency, routewise, routing-weight,
    # provider-route, recent-requests/clear-errors, alert-snooze GET/POST/DELETE,
    # and site-updates CRUD routes (regenerate-api-key removed in #733)
